<?php
    ...
    $sqlSeleccionar = "SELECT * FROM Linea WHERE ID = $ID_u";
    $registros = pg_query($link, $sqlSeleccionar) or die('La consulta de la Linea fallo: ' . pg_last_error($link));
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class = "contenedor_principal">
        ...
        <div class = "segundo">
            <div class="cabecera">
                <h1 class="titulo">Editar Linea</h1>
            </div>
            <form method="POST" name = "formulario" class = "col-4 p-3 m-auto">
                <?php while ($fila = pg_fetch_array($registros)) { ?>
                    ...
                    <div class="mb-1">
                        <label for="txtLinea" class="form-label">Linea: </label>
                        <input type="text" value="<?= $fila[1]; ?>" class="form-control" id="txtLinea" name="txtLinea" placeholder="Linea..." required>
                    </div>
    ...
    <?php
        if(isset($_POST['btnActualizar'])){
            ...
            $sql_actualizar = "UPDATE Linea
                SET id = $ID, Linea = '$Linea'
                WHERE id = '$ID'";
