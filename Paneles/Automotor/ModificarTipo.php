<?php
    ...
    $sqlSeleccionar = "SELECT * FROM Tipo WHERE ID = $ID_u";
    $registros = pg_query($link, $sqlSeleccionar) or die('La consulta del Tipo fallo: ' . pg_last_error($link));
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class = "contenedor_principal">
        ...
        <div class = "segundo">
            <div class="cabecera">
                <h1 class="titulo">Editar Tipo</h1>
            </div>
            <form method="POST" name = "formulario" class = "col-4 p-3 m-auto">
                <?php while ($fila = pg_fetch_array($registros)) { ?>
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" value="<?= $fila[1]; ?>" class="form-control" id="txtTipo" name="txtTipo" placeholder="Tipo..." required>
                    </div>
    ...
    <?php
        if(isset($_POST['btnActualizar'])){
            ...
            $sql_actualizar = "UPDATE Tipo
                SET id = $ID, Tipo = '$Tipo'
                WHERE id = '$ID'";
            $res = pg_query($link, $sql_actualizar) or die('La edición de datos de Tipo fallo: ' . pg_last_error($link));
